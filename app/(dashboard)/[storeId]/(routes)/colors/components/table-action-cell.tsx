...
import { ColorColumn } from './table-columns'
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
import { useDeleteColor } from '@/service-hooks/color'
...
const TableActionCell = ({ data }: Props) => {
    ...
    const { mutateAsyncQuery: mutateDeleteQuery, isLoading: isDeleting } = useDeleteColor(data.id)
